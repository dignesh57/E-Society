					...
					<div class="col-md-12">
						<table
							...
							<thead>
								...
								<th colspan="2"><h4
										class="main-title-w3layouts mb-2 text-center"><%=FormFieldUltilityconstant.mst_maintenance_title%></h4></th>
							</thead>
							<%
								//String[] field = FormFieldUltilityconstant.mst_maintenance;
								for (int i = 0; i <= 5; i++) {
							%>
							<tr>
								...
								<td><input type="text"
									...
									class="form-control" value="<%=getData.get(i) %>" required="required"
									placeholder="Your <%=FormFieldUltilityconstant.mst_maintenance[i]%> Please"></td>
							</tr>
							<%
								}
							%>
							<tr>
								<td colspan="2" style="text-align: center;"><input
									...
									formname="<%=FormFieldUltilityconstant.mst_maintenance_name%>"
									name="action"></td>
