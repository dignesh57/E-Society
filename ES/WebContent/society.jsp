...
<body>
<%String area=request.getParameter("value"); %>
	<select class="custom-select" id="SocietyName" name="SocietyName">
										<%
											DbTransction dbt = new DbTransactionImpl();
													DbTransactionServices dbts = new DbTransactionServicesImpl();
													ArrayList<String> getData = dbts.getSocforSelect(area);												
										%>
		...
		$('#SocietyName').on('change',function(){
