										...
										<table class="table table-striped">
											<tbody>
												<tr class="<%=hth.getWorkerRequest().getTableClass()%>">
													<th><%=HtmlReportHeaderDesign.getReoprtDesign(HtmlTableHeader.getServiceRequest(), ReportConstant.complateWork,0)%></th>
												</tr>
												<%
													DbTransction dbt = new DbTransactionImpl();
													ArrayList<RequestServices> getComplWork = dbt.getCompletedWork(userData.getEmail_id());
