...
<!-- navbar-->
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="Worker.jsp" class="navbar-brand scrollTo">E-Society</a>
          <button type="button" data-toggle="collapse" data-target="#navbarcollapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right"><span class="fa fa-bars"></span></button>
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="Worker.jsp#home" class="nav-link link-scroll">Home</a></li>
              <li class="nav-item"><a href="Worker.jsp#requests" class="nav-link link-scroll">Requests</a></li>
              <!-- <li class="nav-item"><a href="Worker.jsp#testimonials" class="nav-link link-scroll">Contact</a></li> -->
              <li class="nav-item"><a href="WorkerWork.jsp" class="nav-link link-scroll">My Work</a></li>
              <li class="nav-item"><a href="LeftWork.jsp" class="nav-link link-scroll">Left Work</a></li>
            <!--   <li class="nav-item"><a href="DeclineWork.jsp" class="nav-link link-scroll">Decline Work</a></li> -->
              <li class="nav-item"><a href="WorUserProfile.jsp" class="nav-link link-scroll">My Profile</a></li>
              <li class="nav-item"><a href="logout.jsp" class="nav-link link-scroll">Logout</a></li>
            </ul>
          </div>
        </div>
      </nav>
