...
public class register_worker {

	private String role,state,city,area,address,pincode,service_type,service_desc,available_from
	,available_to,w_name,w_email,w_gender,w_phone,id_proof,id_number,id_upload,entered_by,entered_on,last_updated_by,last_updated_on,is_active_Y_N;
	private int imgpath;
