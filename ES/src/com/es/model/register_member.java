...
public class register_member {
	...
	private String role,state,city,area,soc_name,wing,house_type,house_num,member_id,name,email,phone_no,gender,id_proof,id_number,id_upload,entered_by,entered_on,last_updated_by,last_updated_on,is_active_Y_N;
	private int imgpath;
